var estimateDetail = (function () {
    ...
    function loadRegularStrings() {
        $.ajax({
            type: "GET",
            url: '/Estimates/GetRegularObjects',
            data: "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (listObjects) {
                regularObjects = listObjects;
                autocomplete(document.getElementById("Estimate_Objet"), regularObjects);
            },
            error: function (e) {
        ...
        $.ajax({
            type: "GET",
            url: '/Estimates/GetRegularDescriptions',
            data: "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
